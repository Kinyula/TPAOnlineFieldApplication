 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\GroupTask> $groupTask
 * @property-read int|null $group_task_count
 ...
 * @property int $id
 * @property int $user_id
 * @property int $group_task_id
 * @property string $comment
 * @property \Illuminate\Support\Carbon|null $deleted_at
 * @property \Illuminate\Support\Carbon|null $created_at
 * @property \Illuminate\Support\Carbon|null $updated_at
 * @property-read \App\Models\AssignmentGroup|null $assignmentGroup
 * @property-read \App\Models\GroupTask $groupTask
 * @property-read \App\Models\User $user
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Comment whereGroupTaskId($value)
