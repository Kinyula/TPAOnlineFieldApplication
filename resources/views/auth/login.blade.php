    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="block mt-4 flex items-center justify-between">
            ...
            @if (Route::has('password.request'))
                <a class="underline text-sm text-yellow-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800" href="{{ route('password.request') }}">
