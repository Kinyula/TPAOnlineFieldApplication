    ...
    <div class="card-box mb-30 p-3">
        ...
        <form wire:submit.prevent="submitPortApplication" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div>
                ...
                <x-select-input id="module" class="block mt-1 w-full" name="department"
                    wire:model.change="department">
            ...
            <div class="sm:col-span-2 lg:col-span-3">
                ...
                <div
                    class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-dashed border-gray-300 dark:border-gray-700 rounded-md cursor-pointer hover:border-indigo-500 dark:hover:border-indigo-600 focus-within:ring-2 focus-within:ring-indigo-500 dark:focus-within:ring-indigo-600 focus-within:border-indigo-500 dark:focus-within:border-indigo-600 transition duration-150 ease-in-out">
                    <div class="space-y-1 text-center">
                        <label for="application_letter" class="cursor-pointer">
                            <svg class="mx-auto h-10 w-10 text-gray-400 dark:text-gray-500 hover:text-indigo-500 dark:hover:text-indigo-600"
                                fill="none" stroke="currentColor" viewBox="0 0 48 48" aria-hidden="true">
                                <path
                                    d="M8 16c0-4.418 3.582-8 8-8h16c4.418 0 8 3.582 8 8v16c0 4.418-3.582 8-8 8H16c-4.418 0-8-3.582-8-8V16z"
                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M32 16l-8 8-8-8M24 24v-8" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" />
                            </svg>
                        </label>
                        <div class="flex text-sm text-gray-600 dark:text-gray-400">
                            <label for="application_letter"
                                class="relative cursor-pointer bg-white dark:bg-gray-800 rounded-md font-medium text-indigo-600 dark:text-indigo-500 hover:text-indigo-500 dark:hover:text-indigo-400 focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-500 dark:focus-within:ring-indigo-600 focus-within:ring-offset-2">
                                <span>Upload an application letter</span>
                                <input id="application_letter" name="application_letter" type="file" class="sr-only"
