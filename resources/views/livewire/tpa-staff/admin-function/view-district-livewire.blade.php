<div class=" mb-30 p-6 shadow-lg rounded-lg">
    <span>
        <span class="text-sm text-yellow-500 mr-2">Total Districts:</span>
        <span class="text-lg">{{ Illuminate\Support\Number::abbreviate($totalDistricts) }}</span>
    </span>

    <h3 class="text-2xl font-bold mb-6 text-yellow-500 flex items-center">
        <i class="fas fa-flag px-2"></i> Districts
    </h3>
            ...
            <tbody class="text-sm">
                ...
                @foreach ($districts as $district)
                    <tr class="border-b">
                        ...
                        <td class="px-6 py-4">{{ $district->region->region }}</td>
                        <td class="px-6 py-4">{{ $district->district }}</td>
                        <td class="px-6 py-4">
