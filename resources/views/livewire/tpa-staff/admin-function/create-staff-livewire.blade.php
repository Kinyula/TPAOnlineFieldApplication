    ...
    <div class="card-box mb-30 p-3">
        @if (session()->has('staff'))
            <div role="alert" class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative">
                ...
                <strong class="font-medium">{{ session('staff') }}</strong>
            </div>
        @endif
        ...
        <form wire:submit.prevent="createStaff" class="space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <x-select-input id="department" class="block mt-1 w-full" name="department"
                ...
                <div>
                    <span class="flex relative top-3">
                        <x-input-label for="check_number" :value="__('Check Number')" />

                    </span>
                    <x-text-input id="check_number" class="block mt-1 w-full" type="text" name="check_number"
