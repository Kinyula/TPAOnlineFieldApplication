<div>
    @if (auth()->user()->position === 'tpa supervisor')
        <div class="bg-white shadow-lg rounded-lg p-6">
            ...
            <h3 class="text-2xl font-bold mb-3 text-yellow-500"><i class="fas fa-tasks"></i> Group Assignment Details
            </h3>
                    ...
                    <tbody class="text-gray-700">
                        @forelse ($assignments as $assignment)
                            <tr class="border-b">
                                ...
                                @if ($assignment->assignmentGroup->tpaFieldApplications->user_id == auth()->user()->id)
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center p-4 text-gray-500">Not assigned yet.</td>
                            </tr>
                        @endforelse
                    </tbody>
            ...
            <div class="container mx-auto p-4 card-box">
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full bg-white border border-gray-200">
                        ...
                        <tbody>
                            <tr>
                                <td colspan="6" class="px-4 py-2 text-center">No group information because you are
                                    not assigned yet in any group</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
